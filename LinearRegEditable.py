...
def linReg(tup,pred,n): #n is the number of independent variables
    ...
    XT_train, XT_test, y_train, y_test = train_test_split(X, y, test_size=0.5,random_state=1)
    ...
    print('Variance score: {}'.format(model.score(XT_test, y_test)))
    if n==3:
...
def implement(n1,n2,pred1,pred2,pred3,name="COVID_Dataset.csv"):
    ...
    #print(t1)
    return
#implement(5,9,[0,1,0],[20],[20,0,1,0])
